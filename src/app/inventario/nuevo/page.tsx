    ...
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-xl shadow p-6 max-w-5xl">
        <form className="space-y-6" onSubmit={handleSubmit} noValidate>
          ...
          {/* Selector 'Tipo de producto' (Reventa/Repuesto/Servicio) oculto en
              FLUX Nutrition: no aplica al negocio. El estado sigue existiendo
              con su default ('reventa') y las validaciones que dependen de
              tipo_producto se comportan como si el usuario hubiera elegido
              Reventa, que es el flujo normal de venta de productos. */}
