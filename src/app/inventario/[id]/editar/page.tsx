    ...
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-xl shadow p-6 max-w-5xl">
        <form className="space-y-6" onSubmit={handleSubmit} noValidate>
          ...
          {/* Selector 'Tipo de producto' oculto en FLUX Nutrition (mismo criterio
              que Nuevo producto): el estado sigue vivo con su default y las
              validaciones se comportan como Reventa. */}
